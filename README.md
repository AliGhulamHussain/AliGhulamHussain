...
# Hi, I'm Ali Ghulam Hussain 👋
### Full-Stack Developer | Building Real Software for Real Businesses
...
### 📦 BS Traders — Distribution Management System
> **Live:** [bstraders.shop](https://bstraders.shop)

Full distribution management system built for a real business in Pakistan. Dual-role architecture — Admin dashboard for full control and a mobile-first Booker interface for field operations. Installable as a mobile app via PWA.

**Features:** Order booking · Customer ledger (Khata) · Inventory management · Vendor & purchase management · Payroll · Analytics dashboard

**Stack:** `React` `Node.js` `Express` `SQLite` `PWA` `Cloudflare`

---

### 🌍 UK Shop — E-Commerce Platform
> **Live:** [ukshop.co.za](https://ukshop.co.za)

Full e-commerce platform built for an international client in South Africa. Shipped entirely remotely — from requirements gathering to production deployment.

**Features:** Product catalog · Cart & checkout · Cash on Delivery · Admin dashboard · AI-generated product descriptions using Gemini AI

**Stack:** `React` `TypeScript` `Node.js` `SQLite` `Gemini AI` `Cloudflare`
...
Complete business management system for a flour mill. Covers the entire business workflow — from raw material intake to final sale, including a pisai (grinding) service for walk-in customers.

**Features:** Raw material management · Production tracking · Pisai service · Counter sales POS · Customer ledger · Expense tracking · Daily/monthly reports

**Stack:** `React` `Node.js` `Express` `SQLite` `PM2`

---

### 🏫 Kashaf Institute — School Management System
> **Type:** Offline System · Deployed & running in a real institution in Badin

Complete institutional management system deployed and actively used at Kashaf Institute of Paramedics. Migrated 116+ existing student records on launch.

**Features:** Course & batch management · Student enrollment · Fee collection & tracking · Attendance · Finance & expense management · JWT-based role auth

**Stack:** `React` `TypeScript` `Node.js` `Express` `SQLite` `Shadcn/ui`
...
Complete POS and inventory system built for a hospital pharmacy. Handles the critical requirement of tracking medicine batches and expiry dates using FEFO logic.
...
![Ali's GitHub Stats](https://github-readme-stats.vercel.app/api?username=YOUR_GITHUB_USERNAME&show_icons=true&theme=tokyonight&hide_border=true&bg_color=0B0D10&title_color=6E8BFF&text_color=EDEDED&icon_color=6E8BFF)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=YOUR_GITHUB_USERNAME&layout=compact&theme=tokyonight&hide_border=true&bg_color=0B0D10&title_color=6E8BFF&text_color=EDEDED)
